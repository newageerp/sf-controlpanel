...
/**
 * @Route(path="/app/nae-core/config-widgets")
 */
class ConfigWidgetsController extends ConfigBaseController
{
     ...
     * @OA\Post (operationId="NaeConfigWidgetList")
     */
     ...
     * @OA\Post (operationId="NaeConfigWidgetSave")
     */
     ...
     * @OA\Post (operationId="NaeConfigWidgetRemove")
     */
